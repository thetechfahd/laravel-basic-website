        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li class="{{Request::path() === '/' ? 'active' : ''}}"><a class="scroll" href="/">Home</a></li>
              <li class="{{Request::path() === 'about' ? 'active' : ''}}"><a class="scroll" href="/about">About</a></li>
              <li class="{{Request::path() === 'service' ? 'active' : ''}}"><a class="scroll" href="/service">Service</a></li>
              <li class="{{Request::path() === 'features' ? 'active' : ''}}"><a class="scroll" href="/features">Features</a></li>
              <li class="{{Request::path() === 'portfolio' ? 'active' : ''}}"><a class="scroll" href="/portfolio">Portfolio</a></li>
              <li class="{{Request::path() === 'pricing' ? 'active' : ''}}"><a class="scroll" href="/pricing">Pricing</a></li>
              <li class="{{Request::path() === 'team' ? 'active' : ''}}"><a class="scroll" href="/team">Team</a></li>
              <li class="{{Request::path() === 'blog' ? 'active' : ''}}"><a class="scroll" href="/blog">Blog</a></li>
              <li class="{{Request::path() === 'contact' ? 'active' : ''}}"><a class="scroll" href="/contact">Contact</a></li>
            </ul>
          </div>
          <!-- /.navbar-collapse -->
        </div>
